...
为 Minecraft 1.18.2 打造的 Fabric 模组，把**超大私人背包**、**玩家间共享背包**和**便携工作区**整合进同一界面。
...
| --- | --- |
| Minecraft | 1.18.2 |
| Fabric Loader | ≥ 0.14.6（推荐 0.16.0+） |
...
构建产物位于 `build/libs/`，其中 `SharedInventoryMod-fabric-1.18.2-0.5.jar` 为可分发的模组文件。
...
作者：**Petrichor** · 适用于 Minecraft 1.18.2 (Fabric)
