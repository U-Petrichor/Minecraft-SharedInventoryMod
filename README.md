...
为 Minecraft 1.21.5 打造的 Fabric 模组，把**超大私人背包**、**玩家间共享背包**和**便携工作区**整合进同一界面。
...
构建产物位于 `build/libs/`，其中 `SharedInventoryMod-fabric-1.21.5-v1.03.jar` 为可分发的模组文件。
...
作者：**Petrichor** · 适用于 Minecraft 1.21.5 (Fabric)
