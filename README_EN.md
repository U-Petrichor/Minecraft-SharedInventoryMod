...
A Fabric mod for Minecraft 1.21.2 that integrates a **mega private backpack**, **player-shared backpack**, and **portable workstations** into one interface.
...
Author: **Petrichor** · For Minecraft 1.21.2 (Fabric)
