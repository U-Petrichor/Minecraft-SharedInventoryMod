...
A Fabric mod for Minecraft 1.19.2 that integrates a **mega private backpack**, **player-shared backpack**, and **portable workstations** into one interface.
...
Build output is located in `build/libs/`, where `SharedInventoryMod-fabric-1.19.2-1.0.jar` is the distributable mod file.
...
Author: **Petrichor** · For Minecraft 1.19.2 (Fabric)
