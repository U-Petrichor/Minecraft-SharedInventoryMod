 ...
 *
 * 1.21.5 变更:
 *   - ModelPart.rotate(MatrixStack) 改为直接操作矩阵
 *   - ModelTransformationMode 改为 ItemDisplayContext
 *
...
public class BackpackFeatureRenderer extends FeatureRenderer<PlayerEntityRenderState, PlayerEntityModel> {
    ...
    public void render(MatrixStack matrices, VertexConsumerProvider vertexConsumers, int light,
        ...
        // 1.21.5: ItemDisplayContext 替代 ModelTransformationMode
        client.getItemRenderer().renderItem(backpackStack, ItemDisplayContext.GUI, light, OverlayTexture.DEFAULT_UV, matrices, vertexConsumers, null, 0);
