...
public class AnvilData {
    ...
    public void readNbt(NbtCompound nbt, RegistryWrapper.WrapperLookup registryLookup) {
        this.renameText = nbt.getString("AnvilRenameText").orElse("");
        this.repairCost = nbt.getInt("AnvilRepairCost").orElse(0);
        DefaultedListInventory.readFromNbt(this.anvilStack, nbt, "AnvilItems", registryLookup);
    }
    ...
    public void writeNbt(NbtCompound nbt, RegistryWrapper.WrapperLookup registryLookup) {
        ...
        DefaultedListInventory.writeToNbt(this.anvilStack, nbt, "AnvilItems", registryLookup);
    }
}
