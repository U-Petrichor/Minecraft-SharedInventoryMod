 ...
 *
 * 流程: 玩家按 B 键 → 检查当前无界面打开 → 发送 OpenBackpackPayload 到服务端
 * → 服务端 OpenBackpackPayload 处理 → 检查胸甲栏是否穿戴背包 → 打开共享存储界面
 */
public class BackpackKeybind {
    ...
    public static void register() {
        openBackpackKey = KeyBindingHelper.registerKeyBinding(new KeyBinding(
                ...
                GLFW.GLFW_KEY_B,
                net.minecraft.client.option.KeyBinding.Category.create(net.minecraft.util.Identifier.of("shared_inventory_mod", "main"))
        ));
