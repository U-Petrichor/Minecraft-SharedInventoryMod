...
public class SharedInventoryScreen extends HandledScreen<SharedInventoryScreenHandler> implements SharedInventoryScreenHandler.ClientCallback {
    ...
    public void drawBackground(DrawContext context, float delta, int mouseX, int mouseY) {
        ...
        // 标题文字
        Text privateTitle = net.minecraft.text.Text.translatable("screen.shared_inventory_mod.shared_inventory_screen.private_inventory").copy().formatted(net.minecraft.util.Formatting.BOLD);
        Text publicTitle = net.minecraft.text.Text.translatable("screen.shared_inventory_mod.shared_inventory_screen.public_inventory").copy().formatted(net.minecraft.util.Formatting.BOLD);
        ...
        context.drawText(textRenderer,
                net.minecraft.text.Text.of(sharedInventoryPlayerEntity.shared$getPrivateInventory().getCurrentPage() + "/" + sharedInventoryPlayerEntity.shared$getPrivateInventory().getPrivateStackMaxPage()),
    ...
    protected void init() {
        ...
        // 翻页按钮 (95,19) 开始
        addDrawableChild(ButtonWidget.builder(net.minecraft.text.Text.of("<"), button -> this.handler.onPreviousPageButtonClicked())
                .dimensions(guiLeft + 95, guiTop + 19, 12, 12).build());
        addDrawableChild(ButtonWidget.builder(net.minecraft.text.Text.of(">"), button -> this.handler.onNextPageButtonClicked())
        ...
        addDrawableChild(ButtonWidget.builder(net.minecraft.text.Text.translatable("screen.shared_inventory_mod.shared_inventory_screen.button3"), button -> {
                    int page;
                    try {
