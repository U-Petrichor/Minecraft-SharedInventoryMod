...
public class SharedInventoryScreen extends HandledScreen<SharedInventoryScreenHandler> implements SharedInventoryScreenHandler.ClientCallback {
    ...
    public void drawBackground(MatrixStack matrices, float delta, int mouseX, int mouseY) {
        ...
        // 标题文字 - 使用加粗样式和更亮的颜色
        Text privateTitle = Text.translatable("screen.shared_inventory_mod.shared_inventory_screen.private_inventory").formatted(net.minecraft.util.Formatting.BOLD);
        Text publicTitle = Text.translatable("screen.shared_inventory_mod.shared_inventory_screen.public_inventory").formatted(net.minecraft.util.Formatting.BOLD);
