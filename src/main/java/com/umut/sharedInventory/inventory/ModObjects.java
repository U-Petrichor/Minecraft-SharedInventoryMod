...
public class ModObjects {
    ...
    //=== ScreenHandler 注册 ===
    /** 共享存储界面处理器 */
    public static final ScreenHandlerType<SharedInventoryScreenHandler> SHARED_INVENTORY_SCREEN_HANDLER = Registry.register(Registries.SCREEN_HANDLER, new Identifier(SharedInventoryMod.MOD_ID, "shared_inventory_screen_handler"), new ScreenHandlerType<>(SharedInventoryScreenHandler::new));
