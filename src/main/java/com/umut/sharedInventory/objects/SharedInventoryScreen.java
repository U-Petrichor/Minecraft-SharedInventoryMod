...
public class SharedInventoryScreen extends HandledScreen<SharedInventoryScreenHandler> {
    ...
    private final Text privateInventory=Text.translatable("screen.shared_inventory_mod.shared_inventory_screen.private_inventory");
    ...
    protected void init() {
        ...
        this.pageInputField = new TextFieldWidget(
                this.textRenderer,
                ((this.width - this.backgroundWidth) / 2) + 144,
        ...
        addDrawableChild(
                ButtonWidget.builder(
                                Text.translatable("screen.shared_inventory_mod.shared_inventory_screen.button1"),
                        ...
                        .position(
                                ((this.width - this.backgroundWidth) / 2)+40, // X 坐标
        ...
        addDrawableChild(
                ButtonWidget.builder(
                                Text.translatable("screen.shared_inventory_mod.shared_inventory_screen.button2"),
                        ...
                        .position(
                                ((this.width - this.backgroundWidth) / 2)+79, // X 坐标
                                ((this.height - this.backgroundHeight) / 2)+162 // Y 坐标
                        )
                        .build()
        );
        addDrawableChild(
                ButtonWidget.builder(
                        ...
                        .position(
                                ((this.width - this.backgroundWidth) / 2)+118, // X 坐标
                                ((this.height - this.backgroundHeight) / 2)+162 // Y 坐标
                        )
                        .build()
        );
